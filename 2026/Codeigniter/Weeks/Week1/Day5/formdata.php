...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  forEach($numFields as $key => $value){
    try{
        ...
        }else if($value[0] == 'password' && strlen($_POST[$value[0]]) >= 5 && strlen($_POST[$value[0]]) <= 14){
            $ERRORLIST["error"] = "Error: ".$key." must be between 5 and 14 characters long.";
