...
require_once 'classes/ExpenseCalculator.php';
require_once "classes/ExpenseValidator.php";
...
<html lang="en">
  ...
  <body>
    ...
    <form method="POST" action="day6.php" class="row g-3">
  <div class="col-md-4">
...
<script>
   function edelete(eid){
     ...
     $.ajax({
        url: "/practicecode/day6/day6.php",
        type: "POST",
        data: {
            id: eid
        },
